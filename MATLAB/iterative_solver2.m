...
constants
constants_part2_3
P_CPU = 200;                            %CPU Power, W, VARIABLE
P_fan = 200;                            %Fan Power, W, VARIABLE
...
function Q_dot_tot_out = sim(Q_dot_tot_in, cnt, c_p, T_me, T_mi, rho, A_c, D_h, nu, Pr, k, t, L, w, N, L_SIDE, L_DUCT, R_paste, R_cond, T_bulk, Q_fan)
    ...
    cnt = cnt + 1;
    if cnt < 500
        sim(Q_dot_tot_out, cnt, c_p, T_me, T_mi, rho, A_c, D_h, nu, Pr, k, t, L, w, N, L_SIDE, L_DUCT, R_paste, R_cond, T_bulk, Q_fan);
    end
end

sim(0.1, 0, c_p, T_me, T_mi, rho, A_c, D_h, nu, Pr, k, t, L, w, N, L_SIDE, L_DUCT, R_paste, R_cond, T_bulk, Q_fan);