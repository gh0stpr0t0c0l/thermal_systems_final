...
m_dot_air = Q_fan * rho;             %kg/s %Q_dot_tot/(c_p*(T_me-T_mi)) %commented out is the necessary m_dot - requires iterative solution
...
h = Nu*k_air/(D_h)                   %convection heat transfer coefficient, W/(m^2*K) CHECK UNITS
...
h = findh(h_c, t_DUCT, A_c, D_h, T_mi, T_me, c_p, k_air, k_duct, A_c_walls, A_c_CPUs, N, t, L, L_SIDE, L_DUCT, w)